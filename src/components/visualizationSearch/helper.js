import {
    ...
    LAST_14_DAYS,
    LAST_30_DAYS,
    LAST_3_DAYS, LAST_3_MONTHS, LAST_4_QUARTERS,
    LAST_4_WEEKS, LAST_5_YEAR, LAST_6_MONTHS,
    LAST_7_DAYS, LAST_MONTH, LAST_QUARTER,
    LAST_WEEK, LAST_YEAR, MONTHS_THIS_YEAR, QUARTERS_THIS_YEAR, THIS_MONTH, THIS_QUARTER,
    THIS_WEEK, THIS_YEAR,
    TODAY,
    YESTERDAY
} from "./periods";
...
const visualizationTypeMap = {
    [PIVOT_TABLE] : {
        relativePeriods: [ TODAY, YESTERDAY, LAST_3_DAYS, LAST_7_DAYS, LAST_14_DAYS, LAST_30_DAYS, THIS_WEEK, LAST_WEEK, LAST_4_WEEKS, LAST_12_WEEKS, THIS_MONTH, LAST_MONTH, LAST_3_MONTHS, LAST_6_MONTHS, LAST_12_MONTHS, MONTHS_THIS_YEAR, THIS_QUARTER, LAST_QUARTER, LAST_4_QUARTERS, QUARTERS_THIS_YEAR, THIS_YEAR, LAST_YEAR, LAST_5_YEAR ],
        headers: 2,
        columns: 2,
    },
    [LINE] : {
